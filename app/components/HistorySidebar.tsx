    ...
    <>
      ...
      <aside className="w-64 md:w-72 bg-white dark:bg-gray-800 p-4 border-r border-gray-200 dark:border-gray-700 overflow-y-auto flex flex-col flex-shrink-0 h-full">
        ...
        {!historyLoading && isLoggedIn && (
          <>
            {/* Error Display Area */}
            <div className="mb-2 h-4"> {/* Reserve space for errors */}
            ...
            <div className="flex-grow overflow-y-auto mb-4">
                ...
                <ul className="space-y-1">
                    ...
                    >
                        ...
                        <div
                        className={`flex items-center space-x-1 pr-2 transition-opacity duration-150 ${
            ...
            <button
              ...
              className={`mt-auto w-full p-2 text-sm rounded border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-500 text-gray-700 dark:text-gray-300 transition-colors ${
